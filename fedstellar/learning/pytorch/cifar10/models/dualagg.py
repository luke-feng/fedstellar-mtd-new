...
class DualAggModel(pl.LightningModule):
    ...
    def __init__(
        ...
        if confusion_matrix is None:
            self.local_cm = MulticlassConfusionMatrix(num_classes=out_channels)
            self.historical_cm = MulticlassConfusionMatrix(num_classes=out_channels)
            self.global_cm = MulticlassConfusionMatrix(num_classes=out_channels)
